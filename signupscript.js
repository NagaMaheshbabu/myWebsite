...
document.querySelector('#pswd').addEventListener('focus',()=>{
    if(!(pswd.value.match(lowercaseletters)&& pswd.value.match(uppercaseletters)&& pswd.value.match(numbers)&& (pswd.value.length >=8) )){
    ...
    document.querySelector('#formdata').style.height = '430px';
...
form.addEventListener('submit',async(e)=>{
  ...
  setTimeout(()=>{
   ...
   span.remove();
      ...
      if(data === 'Email already exists!' || data ==="User registered successfully!")
      {
